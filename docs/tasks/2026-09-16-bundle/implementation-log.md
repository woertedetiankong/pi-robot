...
- Commit 185d838 publishes the dependency compatibility fixes. Actual pi update of the isolated Git installation succeeded; npm reported zero vulnerabilities. Mixed-PDF real Tesseract smoke also passed.
